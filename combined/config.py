...
lr_disc = 5e-5  # 判别器（DCGAN Discriminator）学习率
...
# ===================== 三目标动态平衡配置 =====================
base_capacity_weight = 3.0  # 提高容量损失权重（秘密嵌入与提取的误差）
base_robustness_weight = 1.5  # 适度提高鲁棒性权重（抗攻击能力）
base_imperceptibility_weight = 0.8  # 降低不可感知性权重（容器与宿主的差异）
